...
(async () => {
  ...
  await fs.writeFile("cardiovascular-events-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("cardiovascular-events-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
